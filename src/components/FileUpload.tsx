...
export const FileUpload = () => {
  return (
    <form className="w-full max-w-6xl bg-gray-800/60 backdrop-blur-lg border border-gray-700/50 rounded-lg shadow-md overflow-hidden">
      
      <div className="p-6 md:p-8">
        <div>
          <h2 className="text-base/7 font-semibold text-white">New Translation</h2>
          ...
          <div className="mt-8 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-2">
              ...
              <div className="flex flex-col flex-grow">
                ...
                <div className="mt-2 flex-grow">
                  <textarea
                    ...
                    className="block w-full h-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6"
                    defaultValue={''}
                  />
                </div>
              </div>
            ...
            <div className="sm:col-span-1 flex flex-col">
              ...
              <div className="mt-2 flex-grow">
                <div className="flex h-full justify-center items-center rounded-lg border border-dashed border-white/25 px-6 py-10">
